...
public class TestNGEmailableReport implements IReporter {
	...
	private String dReportTitle = "Automation Report";
	private String dReportFileName = "emailable-report2.html";
	static Logger log = Logger.getLogger(TestNGEmailableReport.class);
	...
	protected void writeStylesheet() {
		...
		writer.print("th,td {padding: 8px solid black;border:1px solid black;}");
		writer.print("th {vertical-align:bottom}");
		writer.print("td {vertical-align:top}");
		writer.print("tr {border:1px solid black;}");
		...
		writer.print("td.none {border-style: none;}");
		writer.print("tr.none {border-style: none;}");
		writer.print("table.none {border-style: none;}");
		writer.print(
	...
	protected void writeBody() {
		...
		writeEnvDetails(BaseTest.getBrowserCapabilities());
		writeSuiteSummary();
	...
	protected void writeSuiteSummary() {
		...
		writer.println("<div class=\"easy-test-overview\" style ='padding-left:1em;'>");
		writer.println("<table class=\"table-bordered\">");

		writer.print("<tr>");
		writer.print("<th>Test</th>");
		writer.print("<th># No Of TCs</th>");
		...
		for (int i = 0; i < suiteResults.size(); i++) {
			SuiteResult suiteResult = suiteResults.get(i);
			...
			for (int j = 0; j < testResults.size(); j++) {
				...
				int testsCount = passedTests + skippedTests + failedTests;
	...
	protected void writeScenarioSummary() {
		writer.print("<div class=\"easy-test-summary\" style ='padding-left:1em;'>");
	...
	protected void writeEnvDetails(Capabilities cap) {
		writer.print("<div class='center', style = 'margin-left: 14px;'>");
		writer.print("<b>Environment Details </b>");
		writer.print("<table class = 'none'><tbody>");
//		log.info("JOBNAME====="+jenkinsJobName);
//		log.info("BUILD_NUMBER====="+jenkinsBuildNUmber);
//		Properties properties = System.getProperties();
//        // Java 8
//        properties.forEach((k, v) -> log.info(k + ":" + v));
		if (jenkinsJobName != null) {
			writer.print("<tr class = 'none'>");
			writer.print("<td class = 'none'>JOB_NAME</td><td class = 'none'>&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
			writer.print("<td class = 'none'>" + jenkinsJobName + "</td>");
			writer.print("</tr>");
		}
		if (jenkinsBuildNUmber != null) {
			writer.print("<tr class = 'none'>");
			writer.print("<td class = 'none'>BUILD_NUMBER</td><td class = 'none'>&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
			writer.print("<td class = 'none'>" + jenkinsBuildNUmber + "</td>");
			writer.print("</tr>");
		}
		writer.print("<tr class = 'none'>");
		writer.print("<td class = 'none'>Browser</td><td class = 'none'>&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
		writer.print("<td class = 'none'>" + cap.getBrowserName() + "</td>");
		writer.print("</tr>");
		writer.print("<tr class = 'none'>");
		writer.print("<td class = 'none'>Version</td><td class = 'none'>&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
		writer.print("<td class = 'none'>" + cap.getBrowserVersion() + "</td>");
		writer.print("</tr>");
		writer.print("<tr class = 'none'>");
		writer.print("<td class = 'none'>OS</td><td class = 'none'>&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
		writer.print("<td class = 'none'>" + cap.getPlatformName() + "</td>");
		writer.print("</tr>");
		writer.print("<tr class = 'none'>");
		writer.print("<td class = 'none'>Java Version</td><td class = 'none'>&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
		writer.print("<td class = 'none'>" + System.getProperty("java.version") + "</td>");
		writer.print("</tr>");
		writer.print("<tr class = 'none'>");
		writer.print("<td class = 'none'>Username</td><td class = 'none'>&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
		writer.print("<td class = 'none'>" + System.getProperty("user.name") + "</td>");
		if (url != null) {
			writer.print("</tr>");
			writer.print("<tr class = 'none'>");
			writer.print("<td class = 'none'>URL</td><td class = 'none'>&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
			writer.print("<td class = 'none'>" + System.getProperty("url") + "</td>");
			writer.print("</tr>");
		}
		if (jenkinsBuildNUmber != null) {
			try {
				System.setProperty("ExtentReportPath",
						AWSHelper.getInstance().uploadFileToS3Bucket("/TestReport/"+ExtentManager.getReportFileName()));
			} catch (Exception e) {
				e.printStackTrace();
			...
			try {
				System.setProperty("LogPath", AWSHelper.getInstance()
						.uploadFileToS3Bucket("/Logs/Log_" + System.getProperty("current.date.time") + ".log"));
			} catch (Exception e) {
				e.printStackTrace();
			...
			writer.print("<tr class = 'none'>");
			writer.print("<td class = 'none'>Extent Report Path</td><td class = 'none'>&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
			writer.print("<td class = 'none'>https://" + System.getProperty("ExtentReportPath") + "</td>");
			writer.print("</tr>");
			writer.print("<tr class = 'none'>");
			writer.print("<td class = 'none'>Log Path</td><td class = 'none'>&nbsp;&nbsp;:&nbsp;&nbsp;</td>");
			writer.print("<td class = 'none'>https://" + System.getProperty("LogPath") + "</td>");
			writer.print("</tr>");
		}
